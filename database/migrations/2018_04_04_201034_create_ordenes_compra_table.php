...
class CreateOrdenesCompraTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('ordenes_compra', function (Blueprint $table) {
            ...
            $table->integer('tipo_impuesto_id')->unsigned()->nullable();
            $table->integer('tipo_oc_id')->unsigned()->nullable();
            ...
            $table->foreign('tipo_oc_id')->references('id')->on('tipos_orden_compra')->onDelete('cascade');
